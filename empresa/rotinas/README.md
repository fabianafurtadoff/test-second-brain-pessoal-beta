...
Pasta pra descrever automações (crons) que Fabiana Furtado configurou no próprio fluxo.
...
Se Fabiana Furtado opera só via laptop on-demand (sem VPS), essa pasta fica vazia. Nada de rotina automática é obrigatória.
